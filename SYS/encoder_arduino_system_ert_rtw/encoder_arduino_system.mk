###########################################################################
## Makefile generated for component 'encoder_arduino_system'. 
## 
## Makefile     : encoder_arduino_system.mk
## Generated on : Fri Feb 02 16:39:15 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/encoder_arduino_system.elf
...
PRODUCT_NAME              = encoder_arduino_system
MAKEFILE                  = encoder_arduino_system.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/encoder_arduino_system.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/Y5_WIN~1/SENIOR~1/src -I$(START_DIR)/encoder_arduino_system_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=encoder_arduino_system -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/encoder_arduino_system_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/encoder_arduino_system_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/encoder_arduino_system_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
encoder_arduino_system.o : $(START_DIR)/encoder_arduino_system_ert_rtw/encoder_arduino_system.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


encoder_arduino_system_data.o : $(START_DIR)/encoder_arduino_system_ert_rtw/encoder_arduino_system_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/encoder_arduino_system_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetInf.o : $(START_DIR)/encoder_arduino_system_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetNaN.o : $(START_DIR)/encoder_arduino_system_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rt_nonfinite.o : $(START_DIR)/encoder_arduino_system_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
